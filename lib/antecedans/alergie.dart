...
class alergieleInterface extends StatefulWidget {
  final String patientUid; // UID du patient

  const alergieleInterface({super.key, required this.patientUid});

  @override
  _ChirigualeInterfaceState createState() => _ChirigualeInterfaceState();
}

class _ChirigualeInterfaceState extends State<alergieleInterface> {
